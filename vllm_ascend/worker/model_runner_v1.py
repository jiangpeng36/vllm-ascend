...
class NPUModelRunner(LoRAModelRunnerMixin):
    ...
    def __init__(self, vllm_config: VllmConfig, device: torch.device):
        ...
        self.sample_request_q = queue.Queue[(int)](1)
        self.sample_request_q.put(1)
    ...
    def execute_model(
        ...
        self._pre_scheduler_output = copy.deepcopy(scheduler_output)
        self._num_scheduled_tokens_np = copy.deepcopy(num_scheduled_tokens_np)
        self._spec_decode_metadata = copy.deepcopy(spec_decode_metadata)
        self._attn_metadata = copy.deepcopy(attn_metadata)
        self._hidden_states = copy.deepcopy(hidden_states)
        self._aux_hidden_states = copy.deepcopy(aux_hidden_states)
        self._logits = copy.deepcopy(logits)
        self._kv_connector_output = copy.deepcopy(kv_connector_output)
    ...
    def sample(
        ...
        scheduler_output = self._pre_scheduler_output
